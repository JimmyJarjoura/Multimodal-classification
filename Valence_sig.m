...
pin=1;%point in 
pout=w;%point out
Ar_F3=zeros(1,FDlen);%create empty vector of arousal values, pin and pout and pmid
...
pin=1;%point in 
pout=w;%point out
Ar_F4=zeros(1,FDlen);%create empty vector of arousal values, pin and pout and pmid
for i=1:FDlen;%for each sliding window do
